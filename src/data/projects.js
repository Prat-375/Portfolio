...
{
  title: "Paisa – SME Trust Infrastructure Platform",
  slug: "paisa",
  category: "software",
  description:
    "An AI-powered platform connecting private SMEs to investors through Trust Passports, explainable trust scores, and natural language discovery.",
  longDescription:
    "Paisa is a full-stack web application that transforms fragmented SME information into trusted, searchable business intelligence — think Bloomberg Terminal for private companies. SMEs create structured company profiles and receive AI-generated Trust Passports with an explainable Trust Score across 6 dimensions: Innovation, Transparency, Completeness, Founder Verification, Business Activity, and Community Signals. Investors can discover companies using natural language search powered by Google Gemini, save companies to a watchlist, and access detailed due diligence profiles. The frontend is built with React and Vite featuring a dark financial design system, while the backend uses Node.js, Express, and MongoDB. Authentication is role-based (SME vs Investor) using JWT. The application is deployed with Vercel (frontend) and Render (backend).",
  tech: [
    "React",
    "Vite",
    "JavaScript",
  ...
  highlights: [
    "Built a two-sided platform connecting SMEs and investors with role-based JWT authentication",
    "Designed an explainable Trust Score engine across 6 weighted dimensions",
    "Integrated Google Gemini API for AI-generated Trust Passport summaries",
    "Implemented NLP investor search — Gemini extracts structured filters from plain English queries",
    "Designed MongoDB schemas for users, companies (with embedded signals), and watchlists",
    "Built a 4-step company onboarding wizard with real-time trust score calculation",
    "Created investor watchlist system with one-click save and track functionality",
    "Deployed frontend on Vercel and backend on Render with environment-based CORS configuration",
  ],
  image: "images/paisa_paisa.png",
  github: "https://github.com/Prat-375/Paisa",
  demo: "https://paisa-psi.vercel.app/",
},
  {
    title: "Green Basket",
    slug: "green-basket",
